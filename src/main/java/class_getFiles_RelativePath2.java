 ...
 * Class(类名): class_getFiles_RelativePath2
 * Author(作者）: mao
...
public class class_getFiles_RelativePath2
{
    public static LinkedList<String> getFiles_RelativePath(String paths)    //获取某路径下的所有文件，返回相对路径
    {
    ...
    public static void main(String[] args)
    {
        ...
        list2 = getFiles_RelativePath("H:\\程序\\大三上期");
