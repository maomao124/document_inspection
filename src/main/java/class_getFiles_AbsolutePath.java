...
public class class_getFiles_AbsolutePath
{
    public static LinkedList<String> getFiles_AbsolutePath()   //获取工作路径下的所有文件，返回绝对路径
    {
        File file = new File("");
    ...
    {
        LinkedList<String>list=getFiles_AbsolutePath();
